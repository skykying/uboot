...
@ -I /aosp/brandy/u-boot-2014.07/arch/arm/include
@ -I /aosp/brandy/u-boot-2014.07/include/openssl -imultilib .
@ -imultiarch arm-linux-gnueabi
@ -iprefix /aosp/brandy/gcc-linaro/bin/../lib/gcc/arm-linux-gnueabi/4.6.3/
@ -isysroot /aosp/brandy/gcc-linaro/bin/../arm-linux-gnueabi/libc
@ -D __KERNEL__ -D CONFIG_SYS_TEXT_BASE=0x4A000000 -D CONFIG_ARM -D __ARM__
@ -D DO_DEPS_ONLY -D KBUILD_STR(s)=#s
@ -D KBUILD_BASENAME=KBUILD_STR(asm_offsets)
@ -D KBUILD_MODNAME=KBUILD_STR(asm_offsets)
@ -isystem /aosp/brandy/gcc-linaro/bin/../lib/gcc/arm-linux-gnueabi/4.6.3/include
@ -MD arch/arm/lib/.asm-offsets.s.d arch/arm/lib/asm-offsets.c
@ -march=armv7-a -mno-unaligned-access -marm -mno-thumb-interwork
@ -mabi=aapcs-linux -mword-relocations -msoft-float -mtune=cortex-a9
@ -mfpu=vfpv3-d16 -auxbase-strip arch/arm/lib/asm-offsets.s -g -Os -Wall
...
.LFE155:
	...
	.text
.Letext0:
	.file 2 "/aosp/brandy/u-boot-2014.07/arch/arm/include/asm/types.h"
...
.LASF40:
	.ascii	"iobase\000"
.LASF58:
	.ascii	"/aosp/brandy/u-boot-2014.07\000"
.LASF0:
