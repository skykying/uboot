...
s32 sunxi_lcd_dsi_gen_write_15para(u32 screen_id, u8 command, u8 para1, u8 para2,
				  u8 para3, u8 para4, u8 para5, u8 para6, u8 para7, u8 para8, u8 para9, u8 para10,
				  u8 para11, u8 para12, u8 para13, u8 para14, u8 para15)
{
	u8 tmp[15];
	...
	sunxi_lcd_dsi_gen_write(screen_id, command, tmp, 15);
