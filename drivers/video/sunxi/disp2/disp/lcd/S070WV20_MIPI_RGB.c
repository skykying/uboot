...
#define LCD_AT070TN92_800X600 		(0)
#define LCD_JCBOE070018_1024X600 	(1)
...
static void LCD_power_on(u32 sel)
{
	...
	//printf("[M64]LCD_power_on begin\n");
	sunxi_lcd_pin_cfg(sel, 1);

	//printf("[M64]power_en 0\n");
	power_en(0);

	//printf("[M64]sunxi_lcd_delay_ms \n");
	sunxi_lcd_delay_ms(10);

	//printf("[M64]sunxi_lcd_power_enable \n");
	...
	//printf("[M64]power_en 1\n");
	power_en(1);

	//printf("[M64]sunxi_lcd_delay_ms \n");
	sunxi_lcd_delay_ms(50);

	//printf("[M64]panel_reset \n");
	panel_reset(1);
	...
	printf("[M64]LCD_power_on end\n");
}

static void LCD_power_off(u32 sel)
{
	//printf("[M64]LCD_power_off\n");
...
static void LCD_panel_init(u32 sel)
{
	//printf("[M64]LCD_panel_init\n");
#if LCD_JCBOE070018_1024X600

	sunxi_lcd_dsi_gen_write_1para(sel,0x7A,0xC1);
	sunxi_lcd_delay_ms(10);
	sunxi_lcd_dsi_gen_write_1para(sel,0x20,0x00);//0x20
	sunxi_lcd_delay_ms(10);
	sunxi_lcd_dsi_gen_write_1para(sel,0x21,0x58);//0xE0
	sunxi_lcd_delay_ms(10);
	sunxi_lcd_dsi_gen_write_1para(sel,0x22,0x24);//0x13
	sunxi_lcd_delay_ms(10);
	sunxi_lcd_dsi_gen_write_1para(sel,0x23,0x96);//0X28
	sunxi_lcd_delay_ms(10);
	sunxi_lcd_dsi_gen_write_1para(sel,0x24,0x1A);
	sunxi_lcd_delay_ms(10);
	sunxi_lcd_dsi_gen_write_1para(sel,0x25,0x96);
	sunxi_lcd_delay_ms(10);
	sunxi_lcd_dsi_gen_write_1para(sel,0x26,0x00);
	sunxi_lcd_delay_ms(10);
	sunxi_lcd_dsi_gen_write_1para(sel,0x27,0x09);//0x0D
	sunxi_lcd_delay_ms(10);
	sunxi_lcd_dsi_gen_write_1para(sel,0x28,0x29);
	sunxi_lcd_delay_ms(10);
	sunxi_lcd_dsi_gen_write_1para(sel,0x29,0x17);
	sunxi_lcd_delay_ms(10);
	sunxi_lcd_dsi_gen_write_1para(sel,0x34,0x80);
	sunxi_lcd_delay_ms(10);
	sunxi_lcd_dsi_gen_write_1para(sel,0x36,0x96);
	sunxi_lcd_delay_ms(10);
#if MIPI_LAN_2
	sunxi_lcd_dsi_gen_write_1para(sel,0x86,0x29);
	sunxi_lcd_delay_ms(10);
#endif
	...
	sunxi_lcd_delay_ms(10);
	sunxi_lcd_dsi_gen_write_1para(sel,0x56,0x92);//0x92,
	sunxi_lcd_delay_ms(10);
	sunxi_lcd_dsi_gen_write_1para(sel,0x6B,0x51);
	sunxi_lcd_delay_ms(10);
	sunxi_lcd_dsi_gen_write_1para(sel,0x69,0x16);//2B
	sunxi_lcd_delay_ms(10);
	sunxi_lcd_dsi_gen_write_1para(sel,0x10,0x40);//0x55
	sunxi_lcd_delay_ms(10);
	sunxi_lcd_dsi_gen_write_1para(sel,0x11,0x88);
	sunxi_lcd_delay_ms(10);
	...
	sunxi_lcd_delay_ms(10);
#if Bist_mode
	sunxi_lcd_dsi_gen_write_1para(sel,0x56,0x93);
	sunxi_lcd_dsi_gen_write_1para(sel,0x14,0x43);
	sunxi_lcd_dsi_gen_write_1para(sel,0x2A,0x49);//0x49
#endif
